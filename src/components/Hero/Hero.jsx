...
import HeroImg from "../../assets/gojo-hero.png";
import HeroImg2 from "../../assets/gojo.png";
        ...
        <div className="container mt-12 sm:mt-0 pb-20 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-0 relative z-10">
            ...
            <div className="space-y-3 md:space-y-7 flex flex-col justify-center text-center sm:text-left px-10 sm:px-0  ">
              ...
              >
              Gojo Satoru termasuk salah satu karakter yang ditakuti dalam
                anime Jujutsu Kaisen. Ia merupakan penyihir terkuat,
              </p>
              <div
                data-aos="fade-up"
                data-aos-delay="400"
            ...
            >
              <div className="flex items-center justify-end">
                <div className="space-y-4">
                  ...
                  Gojo Satoru adalah karakter dari anime Jujutsu Kaisen.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white m-3 p-5 rounded-lg shadow-md w-full sm:w-[500px]">
              <div className="pb-3 flex justify-between">
                <h1 className="sm:text-xl font-bold ">
                  Follow Saya diTiktok @alwanbalweel
                </h1>
                <IoClose
              ...
              <iframe
                width="100%"
                height="260"
                src="https://www.youtube.com/watch?v=thMXb5r792s"
